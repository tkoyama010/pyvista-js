...
class TestPLYReader:
    ...
    def test_no_vertices(self, tmp_path: Path) -> None:
...
class TestGLTFReader:
    """Tests for GLTFReader."""
    ...
    def test_no_meshes(self, tmp_path: Path) -> None:
...
class TestDownloadDamagedHelmet:
    """Tests for examples.download_damaged_helmet."""

    def test_returns_gltf_mesh(self) -> None:
...
class TestDownloadCadModel:
    """Tests for examples.download_cad_model."""

    def test_returns_stl_mesh(self) -> None:
...
class TestDownloadBunny:
    """Tests for examples.download_bunny."""

    def test_returns_ply_mesh(self) -> None:
...
class TestDownloadLucy:
    """Tests for examples.download_lucy."""
